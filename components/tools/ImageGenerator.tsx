...
const ImageGenerator: React.FC<ImageGeneratorProps> = ({ tool, onBack }) => {
    ...
    const handleGenerate = useCallback(async () => {
        ...
        try {
            // FIX: `generateImage` returns a string array, but the state expects a single string.
            // We take the first element from the result array.
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="mt-6 mb-8 p-4 bg-gray-800 border border-gray-700 rounded-lg text-center">
                <p className="text-sm text-gray-300">
                    <span className="font-semibold text-purple-400">¿Cómo funciona?</span> Escribe una descripción detallada de la imagen que quieres crear. Puedes especificar el estilo, los colores y los elementos. La IA generará una imagen única basada en tu texto.
                </p>
            </div>
            ...
            <div className="mt-8">
                ...
                {generatedImage && (
                    <div>
                        ...
                        <img src={generatedImage} alt="Generated design" className="w-full aspect-square object-cover rounded-lg shadow-lg" />
                    </div>
                )}
            </div>
        </div>
